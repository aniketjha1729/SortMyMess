...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="bs-nav-demo">
        <ul class="nav navbar-nav navbar-right">
            <li><a href="Register.php">Mess Register Page <i class="fas fa-user"></i></a></li>
        </ul>
        <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="index.php">Mess Login Page <i class="fas fa-user"></i></a></li>
        </ul>
      </div>
    </div>
  </nav>
  <div class="container">
    ...
    <font face="FreeSerif">L☺gin</font></p>
    ...
    <form class="box" method="POST" action="Register.php">
        <div class="row">
            <<center><div class="thumbnail">
                <div class="col-sm-8 col-sm-offset-2">
                    <label style="font-size: 20px;"><b>If you are not registered yet, click-></b></label>
